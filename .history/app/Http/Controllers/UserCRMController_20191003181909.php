...
class UserCRMController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        if($request->has('api_token'))
        {
            ...
            if($user)
            {
                ...
                return response()->json('scucess' , 200);
            }
            return response()->json(false, 404);
        }
        return response()->json(false, 401);
    ...
    public function NotifyFirebase(Request $request)
    {
        if($request->has("api_token") && $request->has("NOTIFY_TOKEN"))
        {
            $user = UserCRM::where('USER_TOKEN',$request->get('api_token'))->update([
    ...
    public function getToken(Request $request){
        ...
        return response()->json('Authorizon', 401);
    }
}
