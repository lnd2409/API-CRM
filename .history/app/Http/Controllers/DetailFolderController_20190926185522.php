...
class DetailFolderController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->has("api_token"))
        {
            ...
            if($user)
            {
                DetailFolder::join("crm_user","crm_detail_user_folder.UUID_USER","crm_user.UUID_USER")->where("crm_detail_user_folder.UUID_FOLDER_MANAGEMENT",$request->get("UUID_FOLDER_MANAGEMENT"))
