...
class FolderController extends Controller
{
    ...
    public function destroy(Request $request,$id)
    {
        if($request->has('api_token'))
        {
            $user = UserCRM::where('USER_TOKEN',$request->get('api_token'))->first();
            if($user){
                File::join("crm_comment_file_management","crm_file_management.UUID_FILE_MANAGEMENT","crm_comment_file_management.UUID_FILE_MANAGEMENT")where("UUID_FOLDER_MANAGEMENT",$id)->delete();
